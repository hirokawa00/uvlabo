...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    description: "SPF30とSPF50は実際どれくらい差があるの？計算式で比較しながら、毎日の通勤・お出かけ・アウトドアシーン別の最適な選び方を解説します。",
  ...
  },
  {
    ...
    description: "敏感肌でも安心して使える日焼け止めの選び方。ノンケミカル・無香料・パッチテスト済みの条件を満たしたおすすめ製品を厳選しました。",
    category: "sunscreen",
  ...
  },
  {
    ...
    description: "日焼けしてしまったら、最初の72時間が勝負です。冷却・保湿・美白ケアの正しい順序と、シミを防ぐために今すぐやるべき手順をわかりやすく解説します。",
    category: "aftercare",
  ...
  },
  {
    ...
    description: "PA値の意味・4段階の違い・SPFとの使い分けまで、初めて知る方にもわかりやすく解説します。",
    category: "uv-knowledge",
