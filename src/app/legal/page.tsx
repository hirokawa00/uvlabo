...
const OPERATOR_INFO: TableRow[] = [
  ...
  {
    label: "連絡先",
    value: "サービス内お問い合わせフォームよりご連絡ください",
  },
  {
    label: "サービス内容",
    value: "UV指数の表示・日焼け止め診断・事後ケアガイドの無料提供",
  },
  { label: "料金", value: "無料（一部機能は有料プランを予定）" },
  {
    label: "支払方法",
    value: "クレジットカード（Stripe経由、有料プラン開始時）",
  },
];
                ...
                {[
                  {
                    name: "Amazonアソシエイト",
                    detail:
                      "Amazonが提供するアフィリエイトプログラムです。商品リンクを経由したご購入に対して、売上の一部が報酬として支払われます。",
                  },
                  {
                    name: "A8.net（ファンコミュニケーションズ）",
                    detail:
                      "国内最大級のアフィリエイトサービスを通じた各種美容・スキンケア製品の紹介を行っています。",
                  },
                ].map((program, i) => (
                  <li
                    key={i}
